        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="text-center py-20 flex flex-col items-center justify-center">
              ...
              <Link to='/Booking' className="bg-blue-600 text-black px-8 py-3 rounded-full hover:bg-blue-700/20 transition text">
                Book Appointment
              </Link>
            ...
            <section className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Expert doctors across specialities
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                {/* <Stethoscope className="mx-auto text-blue-600 mb-4" size={48} /> */}
            ...
            <section className="bg-white p-10 riunded-lg shadow-lg">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:scale-105">
                  <p className="italic text-gray-600 mb-4 text-lg">
                    "Exceptional care and compassionate doctots. I felt truly
                    heard and supported."
                  </p>
                ...
                <div className="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:scale-105">
                  <p className="italic text-gray-600 mb-4 text-lg">
                    "Professional, efficient, and very friendly staff. Highly
                    recommended!"
                  </p>
